$(function() {
    ...
    function getPlayerList() {
        ...
        $.ajax({
            ...
            success: function(response) {
                player.musicList = response.data;
                // 遍历获取到的数据，创建每一条音乐
                ...
                initMusicInfo(response.data[0]);
                initMusicLyric(response.data[0]);
            },
            error: function(e) {
                console.log(e);
            }
    ...
    function initMusicInfo(music) {
        ...
        var $musicProgressNameTime = $('.music_progress_time');
        var $musicBG = $('.mask_bg');
        ...
        $musicProgressNameTime.text('00:00/' + music.time);
